 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.mytru.components.helloworld;
...
out.write("\n    ");
_global_model = renderContext.call("use", com.mytru.core.models.HelloWorldModel.class.getName(), obj());
{
